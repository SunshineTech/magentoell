...
/**
 * SDM Note: Had to change one of the lines in _getSimpleRoutes().
 * See note and comment within the function itself.
 */
class Fishpig_Wordpress_Controller_Router extends Fishpig_Wordpress_Controller_Router_Abstract
{
    ...
    protected function _getSimpleRoutes($uri = '')
    {
        ...
        // Rewrite this line becuase it was infinite looping
        //$this->addRoute(array('/^newbloguser\/(.*)$/' => array('code')), '*/index/forwardNewBlogUser');
        $this->addRoute(array('/^newbloguser\/(.*)$/' => array('code')), '*/index/index');
