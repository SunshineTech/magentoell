...
<ul>
	<li>
		<code>
			&lt;?php echo $this->getLayout()->createBlock("sociallogin/buttons")->setTemplate("sociallogin/buttons.phtml")->setNumberButtonShow(number_button_show)->toHtml(); ?&gt;
		</code>
	</li>
</ul>
<br>
<div id="messages">
    <ul class="messages">
        <li class="notice-msg">
            <ul>
                <li>'.Mage::helper('sociallogin')->__('You can put a social buttons block on a cms page. Below is an example which we put a social buttons block with number button show is number_button_show on a cms page').'</li>				
            </ul>
        </li>
    </ul>
</div>
...
<ul>
	<li>
		<code>
			{{block type="sociallogin/buttons" name="buttons.sociallogin" template="sociallogin/buttons.phtml" number_button_show="number_button_show"}}
		</code>
	</li>
</ul>
<br>
<div id="messages">
    <ul class="messages">
        <li class="notice-msg">
            <ul>
                <li>'.Mage::helper('sociallogin')->__('Please copy and paste the code below on one of xml layout files where you want to show the social buttons. Please replace the number_button_show variable with your own number buttons shown').'</li>				
            </ul>
        </li>
    </ul>
</div>
...
<ul>
	<li>
		...
		&nbsp;&nbsp;&nbsp;&nbsp;&lt;action method="setNumberButtonShow"&gt;&lt;number&gt;number_button_show&lt;/number&gt;&lt;/action&gt;<br>
		&lt;/block&gt;
		</code>	
	</li>
</ul>
...
<div id="messages">
    <ul class="messages">
        <li class="notice-msg">
            <ul>			
                <li>'.Mage::helper('sociallogin')->__('Below is an example to show a social login block with 4 buttons on the left of the category page.').'</li>				
            </ul>
        </li>
    </ul>
</div>
