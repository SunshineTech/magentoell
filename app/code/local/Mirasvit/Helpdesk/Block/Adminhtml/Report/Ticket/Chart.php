...
/**
 * @method Mirasvit_Helpdesk_Block_Adminhtml_Report_Ticket_Chart setGrid(Mirasvit_Helpdesk_Block_Adminhtml_Report_Ticket_Grid $grid)
 * @method Mirasvit_Helpdesk_Block_Adminhtml_Report_Ticket_Grid getGrid()
 */
