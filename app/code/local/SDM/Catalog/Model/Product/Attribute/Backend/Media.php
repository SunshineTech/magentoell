...
/**
 * SDM_Catalog_Model_Product_Attribute_Backend_Media class
 */
class SDM_Catalog_Model_Product_Attribute_Backend_Media
    extends Mage_Catalog_Model_Product_Attribute_Backend_Media
{
    /**
     * Add image to media gallery and return new filename. Updated to add update
     * image label.
     *
