 ...
 *
 * Changes to CMS module to allow for special page rendering
 *
 * PHP Version 5
 *
 * @category  SDM
...
/**
 * SDM_Cms_Helper_Page class
 */
class SDM_Cms_Helper_Page extends Mage_Cms_Helper_Page
{
    /**
    * Renders CMS page
    *
    ...
    */
    protected function _renderPage(Mage_Core_Controller_Varien_Action  $action, $pageId = null, $renderLayout = true)
    {
        ...
        // Add a handle for the page type
        $typeHandle = 'page_type_' . $page->getType();
        $action->getLayout()->getUpdate()
            ->addHandle('default')
            ->addHandle('cms_page')
            ->addHandle($typeHandle);
