...
Itoris.WishlistPopup = Class.create({
	...
	addEvents: function() {
		...
		// Just a little shortcut to help out users; nothing crazy if it's removed
		$j('#itoris-wishlist-new-name').click(function(){
			$j('.itoris-wishlist-radio[value="new"]').prop("checked", true);
			obj.checkWishlist($$('.itoris-wishlist-radio[value="new"]')[0]);
		});
	},
