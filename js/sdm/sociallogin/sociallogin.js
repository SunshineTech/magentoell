...
var LoginPopup = Class.create({
    initialize: function(options) {
        ...
        this.login_message  = $('login-message');
        this.forgot_message = $('forgot-message');
    ...
    bindEventHandlers: function() {       
        ...
        $('magestore-sociallogin-popup-email').observe('keypress', this.keypress_handler.bind(this));     
        $('magestore-sociallogin-popup-pass').observe('keypress', this.keypress_handler.bind(this));     
    },
    ...
    hideLoginMessage : function (){
        this.login_message.style.display = "none";      
    },
    showLoginMessage : function (){
        this.login_message.style.display = "block";
    },
    hideForgotMessage : function (){
        this.forgot_message.style.display = "none";     
    },
    showForgotMessage : function (){
        this.forgot_message.style.display = "block";
    },
    hideSocialLogin : function (){
