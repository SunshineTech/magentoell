...
final class SearchString
{
    ...
    public function __construct($rawString)
    {
        ...
        // [TEMPORARY VAGABOND 2 FIX]
        // This is a blatant hack. This is bad, but it works. If this gets overwritten, it's OK.
        // This is only designed to be temporary, thus it should only be treated as temporary.
        $rawString = strtolower($rawString);
        if(strpos($rawString, 'vagabond 2') !== false) {
            $this->rawString = str_replace('vagabond 2', 'vagabond', $rawString);
        }
        // [TEMPORARY VAGABOND 2 FIX]
    }
